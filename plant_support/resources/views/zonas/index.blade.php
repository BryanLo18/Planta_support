        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- La clase `lg:hidden` oculta este bloque en pantallas grandes --}}
                            ...
                            <div class="bg-white p-4 rounded-lg shadow border border-gray-200">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">{{ $zona->tipo_cultivo }}</p>
                                    </div>
                                </div>
                    ...
                    {{-- La clase `hidden lg:block` oculta esto en móviles y lo muestra en pantallas grandes --}}
                    <div class="hidden lg:block">
                         <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre Zona</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cultivo</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($zonas as $zona)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <p class="text-sm font-medium text-gray-900">{{ $zona->nombre_zona }}</p>
                                            <p class="text-sm text-gray-500">{{ $zona->ubicacion }}</p>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $zona->tipo_cultivo }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">No hay zonas de riego creadas.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
